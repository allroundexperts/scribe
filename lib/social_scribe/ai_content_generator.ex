  ...
  def generate_salesforce_suggestions(meeting) do
    case Meetings.generate_prompt_for_meeting(meeting) do
      ...
      {:ok, meeting_prompt} ->
        ...
        Example response format:
        [
          {"field": "Phone", "value": "555-123-4467", "context": "John mentioned 'you can reach me at 555-123-4567'", "timestamp": "01:23"},
          {"field": "Title", "value": "Senior Manager", "context": "Sarah said she was promoted to Senior Manager", "timestamp": "05:47"}
        ]
